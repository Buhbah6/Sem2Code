...
/**
 * Property B is the property class for Question 1.B
...
public class PropertyB {
     ...
     */
    public PropertyB(String address, int zoneCode, int noOfBedrooms, int yearOfConstruction, 
            float riskFactor) {
     ...
     */
    public boolean equals(PropertyB property) {
